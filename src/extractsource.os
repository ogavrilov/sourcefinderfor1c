...
Процедура УстановитьНастройкиВыполнения(НастройкиВыполнения, ИменаНастроек = Неопределено) Экспорт
	Если ИменаНастроек = Неопределено Тогда
		ИменаНастроек = "ВременныйКаталог, ИдентификаторПроцесса, ОписаниеИсходника, ФорматыФайловДляАнализа, ФайлОбработкиВыгрузкиДопОбработок, ФайлРезультатаПроцесса, Лог, ВерсияПлатформы, ИспользоватьРежимАгента, НомерВерсииХранилища";
	КонецЕсли;
